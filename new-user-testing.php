...
<head>
    ...
    <title>Covid Vacccination Portal | New User Vaccination </title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"> covid 19 -Vaccination</h1>
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
                                            ...
                                            <option value="Vector VAccine">Vector Vaccine</option>
                                            <option value="Protien Subunit Vaccine">Protien Subunit Vaccine</option>  
